...
export default function NavMenu() {
  const segment = useSelectedLayoutSegment(); // segment 현재 내 url,
  // ex) compose/tweet -> compose, home -> home
    ...
    <>
      <Link href="/home">
        <li className="group my-1">
          <div
            className={`inline-flex h-[50px] p-[12px] items-center rounded-[29px] transition-all duration-200 group-hover:bg-[rgba(15,20,25,0.1)]`}
          >
            {segment === "home" ? (
              <>
                <svg
                ...
                <div className="ml-[20px] mr-[16px] text-[20px] font-bold">
                  Home
                </div>
              </>
            ) : (
              <>
                ...
                <div className="ml-[20px] mr-[16px] text-[20px]">Home</div>
              </>
            )}
          </div>
        </li>
          ...
          >
            {segment && ["search", "explore"].includes(segment) ? (
              ...
              <>
                ...
                <div className="ml-[20px] mr-[16px] text-[20px]">Explore</div>
              </>
            )}
          </div>
        </li>
          ...
          >
            {segment === "messages" ? (
              ...
              <>
                ...
                <div className="ml-[20px] mr-[16px] text-[20px]">Messages</div>
              </>
            )}
          </div>
        </li>
            ...
            >
              {segment === me.id ? (
                ...
                <>
                  ...
                  <div className="ml-[20px] mr-[16px] text-[20px]">Profile</div>
                </>
              )}
            </div>
          </li>
